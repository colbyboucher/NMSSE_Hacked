...
extends AbstractUnitConverter {
    ...
    public void setAverageCharacterWidthTestString(String newTestString) {
        ...
        this.changeSupport.firePropertyChange(PROPERTY_AVERAGE_CHARACTER_WIDTH_TEST_STRING, oldTestString, newTestString);
    }
    ...
    public void setDefaultDialogFont(Font newFont) {
        ...
        this.clearCache();
        this.changeSupport.firePropertyChange(PROPERTY_DEFAULT_DIALOG_FONT, oldFont, newFont);
    }
