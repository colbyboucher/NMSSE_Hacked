...
public static class AnimatedIcon.AnimationSupport {
    ...
    public static void paintIcon(AnimatedIcon icon, Component c, Graphics g, int x, int y) {
        if (!AnimatedIcon.AnimationSupport.isAnimationEnabled(icon, c)) {
            AnimatedIcon.AnimationSupport.paintIconImpl(icon, c, g, x, y, null);
            return;
        }
        ...
        if (as == null) {
            ...
            if (value != as.targetValue) {
                if (as.animator == null) {
                    AnimatedIcon.AnimationSupport as2 = as;
        ...
        AnimatedIcon.AnimationSupport.paintIconImpl(icon, c, g, x, y, as);
    }
