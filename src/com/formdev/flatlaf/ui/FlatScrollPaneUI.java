        ...
        return e -> {
            ...
            switch (e.getPropertyName()) {
                ...
                case "UPPER_RIGHT_CORNER": {
                    ...
                    if (!(corner instanceof JButton) || !(((JButton)corner).getBorder() instanceof FlatButtonBorder) || this.scrollpane.getViewport() == null || !(this.scrollpane.getViewport().getView() instanceof JTable)) break;
